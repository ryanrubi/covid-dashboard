...
const NavBar = (props) => {
    return(
        <div className="navbar-container">
            <div className={props.theme.toString() === "dark" ? "brand dm-brand" : "brand lm-brand"}><NavLink className="navlink" to="/">Monitor COVID-19</NavLink></div>
            <nav>
                <ul>
                    <li><FontAwesomeIcon icon={faChartLine} className={props.theme.toString() === "dark" ? "icon dm-icon" : "icon lm-icon"}/><NavLink className="navlink" to="/"> Dashboard</NavLink></li>
